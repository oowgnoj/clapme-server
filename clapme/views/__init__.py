...
from .views import ApiUserGoal, ApiGoalSuccessList, ApiGoalCommentList, ApiGoalComment, ApiUser, ApiGoal, ApiHistory, ApiReaction, ApiUserReaction
...
def initialize_routes(api):
    ...
    api.add_resource(ApiGoalComment, '/goal-comment/<int:comment_id>')
